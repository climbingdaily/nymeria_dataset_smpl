...
class Renderer:
    ...
    def render(self, img, smpl_model, cam, human_pc=None, sence_pc_pose=None, mesh_filename=None, color=[1.0, 1.0, 0.9], a=1.0):
        # SMPL
        ...
        if img.shape[-1] == 3:  # 只有 RGB 时添加 Alpha 通道
