...
try:
    ...
    from 3rdParties/body_visualizer.mesh.psbody_mesh_cube import points_to_cubes
    from 3rdParties/body_visualizer.mesh.psbody_mesh_sphere import points_to_spheres
    from 3rdParties/body_visualizer.tools.mesh_tools import rotateXYZ
    from 3rdParties/body_visualizer.tools.vis_tools import colors
